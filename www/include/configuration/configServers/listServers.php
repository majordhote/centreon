...
for ($i = 0; $config = $DBRESULT->fetchRow(); $i++) {
    ...
    */
    ...
    $elemArr[$i] = array(
                 ...
                 "RowMenu_startTime" => (isset($nagiosInfo[$config["id"]]["is_currently_running"]) && $nagiosInfo[$config["id"]]["is_currently_running"] == 1) ? $nagiosInfo[$config["id"]]["program_start_time"] : "-",
                 ...
                 "RowMenu_lastUpdateTime" => (isset($nagiosInfo[$config["id"]]["last_alive"]) && $nagiosInfo[$config["id"]]["last_alive"]) ? $nagiosInfo[$config["id"]]["last_alive"] : "-",
